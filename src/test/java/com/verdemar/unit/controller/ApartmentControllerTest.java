...
class ApartmentControllerTest {
    ...
    void testGetAllApartments() throws Exception {
        Apartment apt = new Apartment((short) 1, ApartmentType.ONE_BEDROOM, (short) 2, (short) 1, "Bonito estudio", null);
    ...
    void testGetApartmentById() throws Exception {
        Apartment apt = new Apartment((short) 2, ApartmentType.ONE_BEDROOM, (short) 4, (short) 2, "Duplex con vistas", null);

        Mockito.when(apartmentService.getApartmentById((short) 2)).thenReturn(apt);

        mockMvc.perform(get("/api/apartments/2"))
                .andExpect(status().isOk())
    ...
    void testUpdateApartment() throws Exception {
        Apartment apt = new Apartment((short) 3, ApartmentType.ONE_BEDROOM, (short) 3, (short) 1, "Suite reformada", null);

        Mockito.when(apartmentService.updateApartment(Mockito.eq((short) 3), Mockito.any(Apartment.class)))
                .thenReturn(apt);

        mockMvc.perform(put("/api/apartments/3")
    ...
    void testGetApartmentTypes() throws Exception {
        ...
        mockMvc.perform(get("/api/apartments/types"))
                .andExpect(status().isOk())
    ...
    void testGetAvailableApartments() throws Exception {
        ...
        Mockito.when(apartmentService.getAvailabilityList(
    ...
    void testGetAllIds() throws Exception {
        ...
        mockMvc.perform(get("/api/apartments/ids"))
                .andExpect(status().isOk())
